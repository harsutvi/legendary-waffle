...
df_average %>% 
  ...
  geom_line(aes(y=Average, color="Total Average"), size=1.5)+
  labs(color="Location in the atmosphere", title="Average temperature in the atmostsphere", y="Average temperature (Celsius)", x="Year")
